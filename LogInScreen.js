...
export default function LogInScreen({ navigation }) {
  ...
  const handleLogin = () => {
    if (validateEmail()) {
      ...
      navigation.navigate('SelectLocationScreen'); // hoặc màn hình bạn cần chuyển
    }
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={require('../assets/camcarot.png')} style={styles.logo} />
      ...
      <View style={styles.passwordContainer}>
        ...
        <TouchableOpacity onPress={() => setSecureTextEntry(!secureTextEntry)}>
          <Image
            source={require('../assets/conmat.png')}
